    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(view, mover, getRemoveDuration() + 200);
            } else {
                mover.run();
            }
        }
...
//        holder.itemView.setAlpha(0);
        ...
        holder.itemView.setTranslationX(-width / 2f);
        holder.itemView.setTranslationY(itemHeight);
    ...
    void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.scaleX(1).scaleY(1).translationX(0).translationY(0).setDuration(getAddDuration())
